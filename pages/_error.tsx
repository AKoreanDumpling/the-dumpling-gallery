		...
		<>
			...
			<main className="mx-auto max-w-[1960px] p-4">
				...
				<div className="display-grid place-items-center">
					...
					<div className="after:content relative h-[629px] sm:max-w-1/1 max-w-1/4 mb-5 flex flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
						...
						<p className="max-w-[60ch] text-white/75 sm:max-w-[40ch] mt-0 mb-0">
							<em>Please try your request again.</em>
						</p>
