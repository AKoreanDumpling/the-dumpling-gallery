		...
		<>
			...
			<main className="mx-auto max-w-[1960px] p-4">
				...
				<div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
					<div className="after:content relative mb-5 flex max-w-full h-[629px] flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
						...
						<Link
							href="/login"
							className="pointer z-10 mt-0 rounded-lg border border-purple-400 bg-gradient-to-r from-purple-600 to-pink-600 px-3 py-2 text-sm font-semibold text-white transition hover:from-purple-700 hover:to-pink-700"
						>
							🔒 Private Access
						</Link>
