		...
		<>
			...
			<main className="mx-auto max-w-[1960px] p-4">
				...
				<div className="display-grid place-items-center">
					...
					<div className="after:content relative h-[629px] lg:max-w-1/3 mb-5 flex flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
						...
						<h1 className="mt-8 mb-4 text-base font-bold uppercase tracking-widest">
							Error 503:<br />The Dumpling Gallery is down for Maintenance
						</h1>

						<p className="max-w-[60ch] text-white/75 sm:max-w-[40ch] mt-0 mb-0">
							We will be back online shortly with updated photos.
						</p>
			...
			<footer className="p-6 text-center text-white/80 sm:p-12">
				...
				<p className="text-white/75">
					HTTP 503: Service Unavailable - The server is currently unable to handle the request due to maintenance downtime.
				</p>
				<br />
				<a
