...
function Footer() {
	const handlePhotosLinkClick = () => {
		try {
			sessionStorage.setItem(FOOTER_ACCESS_KEY, "true");
		} catch {
			// Ignore storage failures; access will be checked on the photos page.
		}
	};
	...
	return (
		<footer className="p-6 text-center text-white/80 sm:p-12">
			<hr />
			<h1 className="mt-6 mb-2 text-base font-bold uppercase tracking-widest" id="credits">
				<a href="/easteregg?from=footer" onClick={handlePhotosLinkClick}>Photos:</a>
			</h1>
			<div className="mt-4">
				<a
